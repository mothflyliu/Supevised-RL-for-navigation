...
class Respawn():
    def __init__(self):
        ...
        # self.modelPath = self.modelPath.replace('/home/hgf/mywork/src/supevised RL for navigation/lib/envs','/home/hgf/mywork/src/supevised RL for navigation/lib/envs/model.sdf')      
        self.modelPath = 'lib/envs/model.sdf'     
        self.f = open(self.modelPath, 'r')
        self.model = self.f.read()
        # self.stage = rospy.get_param('/stage_number')
        self.stage = 4
        self.goal_position = Pose()
        self.init_goal_x = 5.5
        self.init_goal_y = 4.5
    ...
    def getPosition(self, position_check=False, delete=False):
        ...
        if self.stage != 4:
            ...
            self.goal_position.position.x = 5.5
            self.goal_position.position.y = 4.5
        time.sleep(0.5)
        self.respawnModel()
