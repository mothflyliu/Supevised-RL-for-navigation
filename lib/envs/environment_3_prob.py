...
class Env():
    ...
    def setReward(self,goal_distance, done, actual_state):
        ...
        if actual_state==30:
            ...
            reward = 0
            # if (goal_distance - self.last_goal_distance)>0:
            #     if actual_state in list:
            #             reward = -1*0.9*(goal_distance - self.last_goal_distance)
            #     else:
            #             reward = -1*0.9*(goal_distance - self.last_goal_distance)
            # else:
            #     if actual_state in list:
    ...
    def step(self, action, pre_state):
        ...
        reward = self.setReward(goal_distance,done,state_index)
